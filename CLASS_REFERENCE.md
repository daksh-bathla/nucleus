...
| `.n-disabled` | Applies opacity: 0.5; pointer-events: none. |
...
| `.n-selected` | Applies border-color: var(--n-primary); background: rgba(79, 70, 229, 0.08). |
...
| Class | Description |
| --- | --- |
| `.n-dark-mode` | Applies --n-text: #e2e8f0; --n-text-muted: #94a3b8; --n-bg: #0f172a; --n-bg-muted: #1e293b; --n-border-color: #334155; --n-light: #1e293b; --n-dark: #f1f5f9; --n-surface: #0f172a; --n-surface-raised: #172033; --n-surface-sunken: #0b1220; --n-overlay: rgba(2, 6, 23, 0.76); color-scheme: dark. |
